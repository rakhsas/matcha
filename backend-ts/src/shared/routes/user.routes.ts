...
// import { getUsersWithRelations } from '../../modules/user/user.controller.js';
...
// router.get('/users/infos', authMiddleware, getUsersWithRelations)
router.get('/users/profile/:username', authMiddleware, )
